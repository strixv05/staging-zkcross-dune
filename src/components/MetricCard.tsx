...
const MetricCard = ({ title, value, subtitle, lastUpdated = "4h", isLastActive = false }: { title: string; value: string; subtitle: string; lastUpdated?: string; isLastActive?: boolean }) => (
